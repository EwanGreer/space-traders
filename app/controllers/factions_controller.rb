class FactionsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to factions_path, status: :see_other, notice: "Faction was successfully destroyed." }
  ...
  private
    ...
    def faction_params
      params.expect(faction: [ :symbol, :name, :desctiption, :headquarters_id ])
    end
end
