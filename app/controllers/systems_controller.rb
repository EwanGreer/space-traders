class SystemsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to systems_path, status: :see_other, notice: "System was successfully destroyed." }
  ...
  private
    ...
    def system_params
      params.expect(system: [ :symbol, :sector_symbol, :constellation, :name, :type, :x, :y ])
    end
end
