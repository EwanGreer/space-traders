...
class FactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faction" do
    assert_difference("Faction.count") do
      post factions_url, params: { faction: { desctiption: @faction.desctiption, headquarters_id: @faction.headquarters_id, name: @faction.name, symbol: @faction.symbol } }
    end
  ...
  test "should update faction" do
    patch faction_url(@faction), params: { faction: { desctiption: @faction.desctiption, headquarters_id: @faction.headquarters_id, name: @faction.name, symbol: @faction.symbol } }
